			...
			<section id="about" className="main special">
				<div className="container">
					<div className="content">
						...
						<p>En mi experiencia laboral he recorrido varias áreas de la informática, desde soporte técnico en TI hasta arquitecto de información para plataformas web. En los últimos años he decidido y me ha interesado definirme como Desarrollador y por lo tanto, busco siempre mantenerme actualizada de los últimos estándares de programación, mejorar y apostar por nuevos retos.</p>
					</div>
